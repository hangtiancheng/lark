...
module.exports = {
  module: {
    rules: [{ test: /\.html$/, use: larkMvcLoader() }],
  },
};
```
...
```ts
import { larkMvcLoader } from "@lark.js/mvc/rspack";
...
| `@lark.js/mvc/webpack`  | Webpack loader (`larkMvcLoader`)                                               |
| `@lark.js/mvc/rspack`   | Rspack loader (`larkMvcLoader`)                                                |
