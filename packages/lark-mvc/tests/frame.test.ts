...
describe("Frame", () => {
  ...
  describe("mountZone / unmountZone", () => {
    it("mountZone scans #view child elements and mounts them", () => {
      ...
      parentEl.innerHTML = `
        <div id="mz-child-1" ${LARK_VIEW}="test-view-zone"></div>
        <div id="mz-child-2" ${LARK_VIEW}="test-view-zone"></div>
      `;
    ...
    it("mountZone skips elements with frameBound already set", () => {
      ...
      parentEl.innerHTML = `
        <div id="mz-child-3" ${LARK_VIEW}="test-view-zone2"></div>
        <div id="mz-child-4" ${LARK_VIEW}="test-view-zone2"></div>
      `;
      document.body.appendChild(parentEl);
    ...
    it("unmountZone unmounts all child Frames", () => {
      ...
      parentEl.innerHTML = `
        <div id="mz-child-5" ${LARK_VIEW}="test-view-zone3"></div>
        <div id="mz-child-6" ${LARK_VIEW}="test-view-zone3"></div>
      `;
      document.body.appendChild(parentEl);
