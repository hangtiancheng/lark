...
export class LarkFoldingRangeProvider implements vscode.FoldingRangeProvider {
  ...
  private findBlockRanges(document: vscode.TextDocument, pair: BlockPair): vscode.FoldingRange[] {
    const stack: number[] = [];
    const ranges: vscode.FoldingRange[] = [];
